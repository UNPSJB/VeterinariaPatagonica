# Generated by Django 2.0.8 on 2018-10-25 18:54
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('GestionDeClientes', '0002_auto_20181025_1553'),
        ('GestionDeServicios', '__first__'),
        ('GestionDeInsumos', '__first__'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='practica',
            name='insumosReales',
            field=models.ManyToManyField(through='GestionDePracticas.PracticaInsumo', to='GestionDeInsumos.Insumo'),
        ),
        migrations.AddField(
            model_name='practica',
            name='servicios',
