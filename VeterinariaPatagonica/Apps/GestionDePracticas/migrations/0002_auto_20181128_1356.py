...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='estado',
            name='usuario',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='practica_estados', related_query_name='practica_estado', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
