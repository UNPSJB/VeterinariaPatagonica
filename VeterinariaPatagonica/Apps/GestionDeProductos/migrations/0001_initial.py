    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('stock', models.IntegerField(help_text='Stock del Producto', validators=[django.core.validators.MinValueValidator(1, message='El Stock no puede ser menor a 1'), django.core.validators.MaxValueValidator(100, message='El Stock no puede ser mayor a 100')])),
