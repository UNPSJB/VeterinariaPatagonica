    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo', models.CharField(choices=[('C', 'Consulta'), ('Q', 'Quirurgica')], default='Q', error_messages={'blank': 'El tipo de servicio es obligarotio'}, help_text='Tipo de Servicio (Consulta-Cirugia)', max_length=1)),
