    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': (('servicio_crear', 'crear'), ('servicio_modificar', 'modificar'), ('servicio_eliminar', 'eliminar'), ('servicio_ver_habilitados', 'ver_habilitados'), ('servicio_listar_habilitados', 'listar_habilitados'), ('servicio_ver_no_habilitados', 'ver_no_habilitados'), ('servicio_listar_no_habilitados', 'listar_no_habilitados')),
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
