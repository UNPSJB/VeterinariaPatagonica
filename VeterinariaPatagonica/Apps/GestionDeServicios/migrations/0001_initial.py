    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precioManoDeObra', models.DecimalField(decimal_places=2, error_messages={'blank': 'El precio del servicio es obligarotio'}, max_digits=9, validators=[django.core.validators.MinValueValidator(Decimal('0'), message='El precio no debe ser menor a $0.00'), django.core.validators.MaxValueValidator(Decimal('9000000'), message='El precio no puede ser mayor a $9000000.00')])),
