    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipoDeServicio', models.CharField(choices=[('C', 'Consulta'), ('Q', 'Quirurgica'), ('I', 'Internación')], error_messages={'blank': 'El tipo de servicio es obligatorio', 'invalid_choice': 'Opcion invalida'}, max_length=25)),
