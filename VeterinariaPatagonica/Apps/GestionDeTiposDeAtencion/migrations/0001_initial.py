    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lugar', models.CharField(choices=[('DOM', 'Domicilio'), ('VET', 'Veterinaria')], default='VET', error_messages={'blank': 'El lugar de atencion es obligatorio', 'invalid_choice': 'Opcion invalida'}, max_length=3)),
