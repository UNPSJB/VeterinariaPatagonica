# Generated by Django 2.1.dev20180423170307 on 2019-12-14 23:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipoDeCliente', models.CharField(choices=[('C', 'Comun'), ('E', 'Especial')], default='C', error_messages={'blank': 'El tipo de cliente es obligatorio'}, help_text='Tipo de cliente', max_length=1)),
                ('descuentoServicio', models.DecimalField(blank=True, decimal_places=2, default=Decimal('0'), help_text='Tipo de cliente Especial', max_digits=5, validators=[django.core.validators.MinValueValidator(Decimal('0'), message='El descuento no puede ser menor a 0.00'), django.core.validators.MaxValueValidator(Decimal('100'), message='El descuento no puede ser mayor a 100.00')])),
            ...
            options={
                ...
                'permissions': (('cliente_crear', 'crear'), ('cliente_modificar', 'modificar'), ('cliente_eliminar', 'eliminar'), ('cliente_ver_habilitados', 'ver_habilitados'), ('cliente_listar_habilitados', 'listar_habilitados'), ('cliente_ver_no_habilitados', 'ver_no_habilitados'), ('cliente_listar_no_habilitados', 'listar_no_habilitados')),
                'default_permissions': (),
            },
        ),
    ]
